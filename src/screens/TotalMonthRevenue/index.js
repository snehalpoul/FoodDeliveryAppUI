...
export default class TotalMonthRevenue extends Component {
constructor(props) {
    super(props);
    this.state = {
    loading: true,
    ...
    return (
      <View style={styles.container}>
        <View style={styles.headstyle}>
            ...
            <Text style={styles.heading}>Month Revenue</Text>
         </View>
        <ScrollView>
            <TouchableOpacity 
          ...
          activeOpacity={1.9}
        >
          <Text style={styles.next_button_text}> Total Amount = 55000 INR </Text>
        </TouchableOpacity> 
          <View style={styles.cardstyle1}>
            <View style={{ backgroundColor: "#424242", padding: hp('2%')}}>
                ...
                <Text style={styles.text1}> Total Price:
                 <Text style={styles.text2}>55000 INR </Text>
                </Text>
             </View>
            </View>
        </ScrollView>
